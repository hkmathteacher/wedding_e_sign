...
export const assets = {
    ...
    'crown': { 
        type: 'prop', icon: '👑', 
        svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280 280"><path d="M90 90 L70 50 L110 70 L140 30 L170 70 L210 50 L190 90 Z" fill="#d4af37" stroke="#bfa15f" stroke-width="2"/></svg>` 
    }
};
